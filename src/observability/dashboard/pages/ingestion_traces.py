    ...
    if sparse_store:
        with st.expander("🟨 Sparse Index (BM25)", expanded=True):
            ...
            with sc2:
                ...
                st.markdown(f"**Chunks:** {sparse_store.get('count', 0)}")
